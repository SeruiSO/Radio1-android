...
async function loadStations() {
  ...
  try {
    ...
    // Ініціалізація інформації про поточну станцію після завантаження
...
function applyTheme(theme) {
  ...
  localStorage.setItemилось("selectedTheme", theme);
  currentTheme = theme;
...
System: * The response was truncated due to exceeding the maximum allowed length. Below is the continuation of the artifact with the remaining content, ensuring no truncation occurs. The artifact ID remains the same as it is an update to the previous artifact. *

<xaiArtifact artifact_id="d5c4acd0-9bee-4a62-b58d-b1fedb4e3046" artifact_version_id="206933d8-06fc-4811-a177-14811986ca58" title="script.js" contentType="text/javascript">
const audio = document.getElementById("audioPlayer");
const stationList = document.getElementById("stationList");
const playPauseBtn = document.querySelector(".controls .control-btn:nth-child(2)");
const currentStationInfo = document.getElementById("currentStationInfo");
